let cidades = `Abadia de Goiás (GO)
...
formatado = cidades.split("\n");

cidadesNovo = "";

for (let index = 0; index < formatado.length; index++) {
  cidadesNovo += formatado[index] + ", ";
}

require("fs").writeFileSync("cidadesLista.txt", cidadesNovo);
